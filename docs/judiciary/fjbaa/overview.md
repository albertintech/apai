...
Comprehensive due process protections ensure fairness: written notice of allegations, access to evidence, right to counsel, opportunity to respond, hearing before the Panel, and written decisions with reasons. Complaints and investigations remain confidential until final determination. A justice subject to serious sanctions may appeal to an en banc panel of Senior Justices not serving on the Ethics Review Panel and not currently assigned to vacancy coverage rotation, with the Bridge Panel supplying additional members if the en banc body would otherwise consist of fewer than three. An automatic stay applies pending review.
...
- Updated Title V summary: added vacancy rotation exclusion from Ethics Review Panel; updated Bridge Panel description to reflect expanded trigger beyond transition period; updated en banc appellate review to reflect vacancy rotation exclusion and three-member Bridge Panel minimum
- Updated Phase Three: replaced "full Senior Justice composition" with "predominantly Senior Justice composition" and noted Bridge Panel remains available for vacancy rotation exclusions and recusals
