...
What a carryover nominee must submit:
- An updated professional biography reflecting changes since the prior nomination (§ 202(f)(1)(B))
- An optional supplemental statement of no more than 500 words (§ 202(f)(1)(C))

What a carryover nominee does not need to resubmit:
- The original ten works (§ 202(f)(1)(D))
- The judicial philosophy statement (§ 202(f)(1)(D))
- The attestation of authorship (§ 202(f)(1)(D))
...
- Retitled document: "Federal Judicial Balance and Accountability Act / From Nomination to Confirmation: A Guide to the Justice Selection Pipeline" replaced with "Seating a New Justice / A Guide to the FJBAA's Nomination, Selection, and Confirmation Mechanics"
...
- Replaced *Slate Sizing Formula* subsection with *Slate Sizing Rule*: replaced n×2 minimum / n×2.5 maximum with n+2 minimum, no maximum; updated table to show minimum nominees only; added structural derivation explaining why n+2 preserves full Bloc STAR procedure in every round

**Revision 1.1**
- Updated reference line to reflect FJBAA Rev 2.5
- Corrected Stage Five (Bloc STAR Voting) entirely: replaced simultaneous top-N selection and conditional near-tie runoff with accurate sequential round-by-round description -- one seat per round, mandatory automatic runoff every round, winner removed, repeat
- Added tiered tie-breaking protocol: finalist designation ties resolved by pairwise preference; runoff ties resolved by aggregate score; residual ties resolved by lot conducted by Presiding Officer; Senate may adopt alternatives by rule
- Added advice and consent grounding to Stage Two documentation requirements introduction
- Updated all affected section references to FJBAA Rev 2.5 paragraph numbering

**Revision 1.0**
- Initial publication
- Covers full nomination-through-confirmation pipeline in pipeline-stage format
- Addresses expansion phase, steady state, appointment equalization, documentation requirements, slate sizing, Senate evaluation timeline, Bloc STAR voting mechanics, slate rejection consequences, post-confirmation oath requirements, and transition period provisions
- Legislative citations to FJBAA Rev 2.4 throughout
-->
