...
- Removed references to the APAI Cabinet Risk Matrix composite scoring; structural risk argument expanded to stand independently
- Added FLECA reference in the Compounding Loop section, framing HSRA and FLECA as coordinated architecture
- Revised tone throughout for greater argumentative clarity, particularly in the Risk Profile and Political Economy sections
- Added endnotes and Works Cited section for all empirical claims in the Empirical Record, Political Economy, and Congressional Oversight sections
- Updated FEMA staffing loss figures to reflect confirmed 2025 data (2,000-plus departures; GAO-identified 35 percent staffing deficit)
- Updated CISA staffing loss figures to reflect confirmed data (approximately one-third of workforce)
- Added reference to fatal shootings of U.S. citizens by federal immigration officers in Minneapolis (February 2026)
