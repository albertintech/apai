...
- No changes to analysis content

**Revision 3.6**
- Initial publication

> 📄 [Download this document](https://github.com/albertintech/apai/blob/main/docs/aspc/apna/future-state-analysis.md) (opens on GitHub -- click the ⬇ download button)
