...
- No obvious political axes to grind
...
- Peer review and GAO validation
...
- GAO audits verify absence of partisan bias
- Public confidence in non-partisan operations
...
- Congressional committees view Commission as valuable resource
...
- "Ensures middle-class Americans can serve in Congress"
...
- "Other countries pay more" (sounds defensive)
...
- "I reviewed their evidence and declined to override their professional judgment"
...
- Negative consent preserves congressional authority
- Multiple precedents upheld by courts
...
- Supermajority removal protections
- Annual GAO audits checking for bias
- Public transparency enabling outside scrutiny
...
- Independent commission enables rational resource allocation
...
- Effective governance from properly resourced Congress saves far more through better decisions
- Alternative is continued capacity decay and dysfunction
