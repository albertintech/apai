...
Existing systems rely on adversarial discovery to surface candidate information. Campaigns conduct opposition research. Media organizations investigate claims. Watchdog groups publish findings. This produces several problems.

**Inconsistent coverage.** High-profile races attract investigative resources; lower-profile contests do not. A candidate for a safe House seat may face less scrutiny than a candidate in a competitive Senate race, though both seek federal office with identical constitutional responsibilities.

**Fragmented information.** Findings appear across multiple outlets with varying credibility, accessibility, and permanence. No central repository exists for verified records. Voters must assemble information from disparate sources or rely on partisan summaries.

**Timing failures.** Adversarial discovery often produces findings late in electoral cycles -- after primaries conclude, after early voting begins, or after candidates have already assumed office. The George Santos case illustrated how biographical fabrications can survive an entire campaign cycle undetected.
...
**Federal Candidate Eligibility Panel (Title III).** Constitutional eligibility questions -- age, citizenship, residency, Fourteenth Amendment Section 3 issues -- require judicial resolution, not administrative determination. The Panel provides a dedicated forum with expedited procedures, documentary-based proceedings, and clear evidentiary standards. Separating eligibility adjudication from verification prevents the Agency from acquiring quasi-judicial powers.
...
**"This creates another federal bureaucracy."** The Agency is intentionally minimal: verification of documentary records, publication of findings, referral of eligibility questions to the Panel. It exercises no regulatory, enforcement, or investigative authority. Scope locks prevent mission creep. The structure resembles a library or archive more than a regulatory agency.

**"Verification could be weaponized against disfavored candidates."** Uniform procedures applied identically to all candidates, civil service staffing for verification functions, Inspector General oversight, and explicit prohibitions on selective treatment address this concern. The Act's architecture assumes bad-faith actors and builds structural protections rather than relying on norms of restraint.

**"What is the point if verification does not affect ballot access?"** Informational transparency has independent value. Voters can consider verified records alongside other factors in their electoral decisions. The alternative -- government determining who may appear on ballots based on biographical verification -- would raise serious constitutional concerns about additional qualifications for office.
