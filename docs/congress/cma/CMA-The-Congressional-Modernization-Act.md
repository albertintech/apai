...
**Equipping Congress for the 21st Century**

---

## SECTION 1. SHORT TITLE

This Act may be cited as the "Congressional Modernization Act" or "CMA."
...
4. The American electoral system has produced a Congress unable to address the nation's most pressing challenges. Partisan polarization, legislative gridlock, and declining public trust reflect fundamental structural problems, not merely poor leadership or insufficient civic engagement.

5. The current winner-take-all, single-member district system creates incentives for partisan gerrymandering, safe seats that insulate incumbents from general election competition, and ideological extremism that makes compromise politically dangerous.

6. Only 15-30 House districts (3-7% of all seats) are genuinely competitive under current electoral structures. This means approximately 93-97% of House elections are effectively decided in low-turnout partisan primaries rather than general elections, undermining democratic accountability to the broader electorate.

7. Voters in single-member districts who support losing candidates receive zero representation of their views. In a 435-seat House elected by winner-take-all rules, millions of voters in each election cycle cast ballots that have no influence on who represents them, creating systematic underrepresentation of political minorities in every district and state.

8. House districts now represent an average of 770,000 constituents, making meaningful constituent services impossible and creating barriers between representatives and the people they serve. The original ratio (approximately 30,000:1) was designed to ensure representatives maintained close connections to constituents and could provide meaningful responsiveness to local concerns.
...
10. Piecemeal reforms addressing individual symptoms of electoral dysfunction -- such as redistricting commissions, term limits, or campaign finance restrictions -- cannot solve structural problems requiring systematic electoral architecture changes.

11. Primary elections in single-member winner-take-all districts create incentives for ideological extremism, as candidates must appeal to partisan base voters rather than median general election voters. This dynamic has accelerated partisan polarization and made cross-party coalition-building politically dangerous for incumbents facing primary challenges.

12. Proportional representation through multi-member districts enables multiple political perspectives to win seats in proportion to voter support, creating incentives for coalition-building and compromise while maintaining local accountability through district-based representation.
...
16. Multi-member districts with proportional representation reduce gerrymandering incentives, as manipulating district boundaries cannot eliminate proportional representation of political minorities. While district boundaries still matter, the winner-take-all dynamic that makes gerrymandering so powerful disappears under proportional systems.

17. Proportional representation creates incentives for political parties to appeal to broader coalitions and for candidates to build cross-partisan support, as winning seats requires demonstrating appeal beyond narrow partisan bases.

18. Multi-member districts enable voters to choose among multiple candidates from the same party or political tradition, providing meaningful choice even in areas dominated by one party. This intra-party competition creates accountability and quality control without requiring voters to support parties they oppose.

19. Increasing House size makes gerrymandering mathematically more difficult, as creating manipulated districts becomes exponentially more complex with more districts and smaller district populations.
...
Beginning with the First CMA Election, the House of Representatives shall consist of five hundred ten (510) members.
...
1. At least 12 months before the First CMA Election (510-member capacity);
...
Upon the First CMA Election, each Representative's Member Representational Allowance (MRA) shall increase by 35% above the amount in effect immediately before the First CMA Election, adjusted annually for inflation thereafter.
...
The requirement in 2 U.S.C. Ãƒâ€šÃ‚Â§ 2c that Representatives be elected from single-member districts is hereby repealed. States shall elect Representatives from multi-member districts as provided in this Title.
...
**Transition Cycle 1**: The First CMA Election
...
All candidates meeting ballot access requirements (Title I) appear directly on the general election ballot, with party endorsements (Title II) and FCAO scores (Title V, beginning with the Second CMA Election) displayed.
...
This subsection takes effect for the First CMA Election.
...
All candidates meeting ballot access requirements (Title I) appear directly on the general election ballot for multi-member district seats, with party endorsements (Title II) and FCAO scores (Title V, beginning with the Second CMA Election) displayed.
...
- Determine quota: (Total valid ballots) ÃƒÆ’Ã‚Â· (Seats + 1)
- Candidates meeting or exceeding quota are elected
- Allocate seats using Sequential Proportional Approval Voting logic to maximize voter satisfaction while ensuring proportionality

**Step 3: Runoff Allocation**

- If seats remain after quota candidates elected, conduct automatic runoffs among remaining candidates
- Runoffs consider voter scores to allocate remaining seats to candidates with strongest remaining support
...
#### (j) Contingency Procedures for Certification Delays

**(1) Invocation Threshold**

Contingency procedures may be invoked only where STAR-PR implementation faces temporary, demonstrably objective technical certification obstacles preventing lawful election administration, as certified by the FEC following petition by the affected state.

For purposes of this subsection, "technical certification obstacles" means obstacles arising from:

- Voting equipment vendor inability to achieve federal certification standards despite documented good-faith efforts;
- Verification that no commercially available voting system meets federal STAR-PR specifications; or
- Other objective technical barriers beyond state control and not resulting from state action or inaction.

**(2) Limited Scope**

Contingency procedures:

- Apply only to STAR-PR for multi-member districts, not to single-winner STAR voting;
- Do not excuse states from implementing multi-member districts as required by Section 402;
- Provide temporary alternative tabulation methods only, not permanent substitutes; and
- Terminate automatically upon FEC certification that compliant voting systems are available.

**(3) Interim Tabulation Method**

If contingency invoked, states may temporarily use Approval Voting with Sequential Proportional Approval Voting (SPAV) tabulation for multi-member districts:

- Voters approve or disapprove each candidate (binary choice);
- Seats allocated using SPAV to ensure proportional outcomes;
- Same ballot interface consistency principle applies (voters perform same action across all candidates).

**(4) Mandatory Transition Plan**

States invoking contingency must file with FEC:

- Detailed plan for transitioning to compliant STAR-PR system;
- Timeline for compliance (not to exceed 24 months);
- Progress reports every 90 days; and
- Demonstrated vendor engagement and procurement efforts.

**(5) Annual Certification Renewal**

Contingency status must be recertified annually. FEC may revoke contingency status if:

- State fails to demonstrate good-faith compliance efforts;
- Compliant voting systems become commercially available; or
- Technical obstacles are resolved.

**(6) Voter Action Consistency Maintained**

Even under contingency procedures, voter actions remain consistent: scoring or approving all candidates using same interface and action, with only back-end tabulation varying.
...
#### (c) Immutable Statutory Elements

**(1) Voter-Facing Guarantees**

The following elements of the voting methods established in this Title are statutory guarantees and may not be modified through the technical review process established in this section:

1. **Score range**: Voters shall score candidates using a 0-5 star scale;
2. **Ballot interface consistency**: Voters shall perform the same scoring action for all candidates regardless of contest type;
3. **Universal scoring permission**: Voters may score all candidates, some candidates, or no candidates, and may assign the same score to multiple candidates;
4. **Unscored treatment**: Candidates left unscored shall be treated as receiving 0 stars;
5. **Single-winner STAR structure**: For single-winner contests, the two highest-scoring candidates shall advance to an automatic runoff determined by voter preferences; and
6. **Proportional outcome requirement**: For multi-member districts, seat allocation shall produce proportional representation reflecting the distribution of voter support across candidates.

**(2) Modification of Immutable Elements**

Any modification to the elements specified in subsection (c)(1) requires an Act of Congress amending this Title. The ESO shall have no authority to propose or implement modifications to immutable elements.

#### (d) Adjustable Technical Parameters

**(1) Scope of Technical Review**

The following technical parameters may be modified through the process established in this section:

1. **Quota calculation formula**: The mathematical formula for determining the threshold of votes required for guaranteed seat allocation under STAR-PR;
...
3. **Seat allocation sequence**: The order of operations for allocating seats among candidates meeting or approaching quota thresholds;
...
#### (e) Decennial Technical Review

**(1) Mandatory Review**

Beginning with the first decennial census completed after the Second CMA Election, and following each subsequent decennial census, the ESO shall conduct a comprehensive technical review of voting method performance under this Act.
...
#### (g) Modification Approval Process

**(1) Commission Supermajority**

No modification to adjustable parameters may be transmitted to Congress unless approved by at least five (5) of seven (7) Commissioners.

**(2) Publication and Comment**

Prior to Commission vote, proposed modifications shall be:
...
Upon Commission approval, proposed modifications shall be transmitted to Congress with:
...
5. Certification that boundary conditions in subsection (d)(2) are satisfied.

**(4) Congressional Review Period**

Proposed modifications shall take effect 18 months after transmission to Congress unless, within 120 legislative days of transmission, Congress enacts a joint resolution of disapproval.
...
**(6) Effect of Disapproval**

If Congress enacts a joint resolution of disapproval:
...
**(7) Effect of No Disapproval**

If Congress does not enact a joint resolution of disapproval within 120 legislative days:
...
The ESO's authority to conduct technical reviews and propose modifications shall take effect upon the First CMA Election.

**(3) First Decennial Review**

The first mandatory decennial review shall commence following certification of the first decennial census completed after the Second CMA Election.
...
4. This section takes effect as of the Second CMA Election, as provided in Section 505.
...
1. Commission members may be removed only for cause, including:
   ...
   - Incapacity preventing performance of duties; or
   - Conviction of a felony or crime involving moral turpitude.

2. Removal requires supermajority vote of six of the nine Commission members;
3. The member subject to removal proceedings may not vote on their own removal;
4. Removal decisions are subject to judicial review in federal district court;
5. During removal proceedings, the affected member may be suspended from duties by supermajority vote pending final determination.
...
1. Commission members shall receive compensation at the annual rate for Level III of the Executive Schedule under 5 U.S.C. Ãƒâ€šÃ‚Â§ 5314;
2. Members serving as Chair receive compensation at the annual rate for Level II of the Executive Schedule under 5 U.S.C. Ãƒâ€šÃ‚Â§ 5313;
3. Members are entitled to travel expenses, including per diem in lieu of subsistence, in accordance with 5 U.S.C. Ãƒâ€šÃ‚Â§Ãƒâ€šÃ‚Â§ 5702-5703.
...
3. Maintain a public website containing:
   - Examination content outlines and domain specifications;
   - Sample questions demonstrating question types and difficulty levels;
   - Complete practice examinations for public study;
   - Retired examination questions after removal from active use;
   - Statistical reports on score distributions, demographic performance, and trends;
   - Commission meeting minutes, decisions, and policy statements;
   - Links to GAO audit reports and Commission responses;
4. Respond publicly to comments and concerns about examination content within 60 days;
5. Provide study guides, reference materials, and preparation resources;
6. Conduct public comment periods before major examination revisions;
7. Publish examination blueprints showing content area weightings and question allocation;
8. Make all Commission votes and decisions part of the public record, except deliberations involving specific examination questions in active use.
...
8. The Commission may conduct closed sessions only for:
   - Deliberations on specific examination questions in active use;
   - Personnel matters;
   - Contract negotiations;
   - Security breach investigations;
   - Other matters where public disclosure would compromise examination integrity.
...
3. The Commission may employ professional staff including:
   - Psychometricians and assessment specialists;
   - Content experts in American government and constitutional law;
   - Testing security personnel;
   - Administrative and support staff;
   - Legal counsel; and
   - Other personnel necessary for FCAO operations;
4. The Commission may contract with:
   - Professional testing organizations for examination administration;
   - Subject matter experts for content development;
   - Psychometric consultants for validity studies;
   - Technology vendors for secure online testing platforms;
   - Other qualified entities for services supporting FCAO mission;
5. All contracts shall be awarded through competitive procurement processes ensuring fairness and value;
6. Contracts with testing organizations shall include performance standards, security requirements, and termination provisions.
...
1. Commission decisions are subject to limited judicial review:
   - Examination content decisions, specific questions, and scoring methodologies are not subject to judicial review except for claims of systematic discrimination against protected classes, constitutional violations of fundamental rights, or arbitrary and capricious action demonstrating complete abandonment of professional standards;
   - Procedural decisions regarding examination administration, security, and operations are subject to judicial review under the Administrative Procedure Act;
   - Removal decisions are subject to judicial review in federal district court;
   - Disputes over contract awards are subject to judicial review under applicable procurement law;

2. Courts shall give substantial deference to Commission expertise in psychometrics, assessment validity, and professional testing standards;

3. Emergency judicial relief is available only where examination administration failures threaten to deny ballot access to qualified candidates through no fault of their own;

4. Judicial review actions shall be filed in the United States District Court for the District of Columbia, with appeals to the D.C. Circuit.

**(3) Congressional Oversight**

1. The Commission shall submit annual reports to Congress containing:
   - Examination administration statistics and outcomes;
   - Validity and reliability studies;
   - Demographic performance analyses;
   - Budget and expenditure reports;
   - Security incident reports and corrective actions;
   - Recommendations for statutory improvements;

2. The Commission shall testify before congressional committees upon request;

3. Congress retains authority to:
   - Appropriate initial funding during establishment phase;
   - Conduct oversight hearings;
   - Amend FCAO statutory authority through legislation;
   - Investigate complaints regarding Commission operations;

4. Congress may not:
   - Direct specific examination content or question decisions;
   - Override Commission judgments on individual candidate scores;
   - Interfere with Commission independence in professional matters;
   - Defund FCAO after transition to independent funding (see Section 503(a)(2)).

#### (f) Coordination with Federal Election Commission

1. FCAO shall coordinate with the Federal Election Commission on:
   - State election official training regarding score disclosure requirements;
   - Ballot format standards ensuring clear score presentation;
   - Timeline coordination for candidate filing deadlines and examination completion;
   - Public education campaigns about examination purpose and non-qualifying nature;

2. The FEC shall provide FCAO with:
   - Information on federal candidate filing deadlines by state;
   - Contact information for state election officials;
   - Model ballot language incorporating FCAO scores;
   - Support for voter education regarding examination transparency purpose;

3. FCAO and FEC shall enter a memorandum of understanding within 6 months of Commission appointment establishing coordination procedures;

4. Neither agency shall exercise authority over the other's core statutory functions.
...
3. Contracts shall be awarded within 15 months of enactment based on:
   - Demonstrated experience administering high-stakes professional examinations;
   - Testing center network coverage (nationwide and international);
   - Secure online proctoring capabilities;
   - Disability accommodation expertise;
   ...
   - References from other professional certification bodies;

4. FCAO may contract with multiple testing organizations to ensure:
   - Geographic coverage in all states and territories;
   - Redundancy in case of contractor performance issues;
   - Competition maintaining service quality and cost control;
   - Specialized services (e.g., one contractor for testing centers, another for online proctoring);

5. Contracts shall include performance standards with penalties for:
   - Examination security breaches;
   - Failure to meet score turnaround requirements established by the Commission;
   - Inadequate disability accommodations;
   - Testing center unavailability in required locations;
   - Technical failures affecting candidate testing;
   - Any other failures compromising examination integrity or candidate access.
...
3. Secure online proctoring systems using:
   ...
   - Live or AI-assisted proctoring monitoring candidate behavior;
   - Secure browser technology preventing unauthorized access;
   - Recording capabilities for security review;
4. Established disability accommodation procedures compliant with Americans with Disabilities Act;
5. Item bank security systems preventing unauthorized access;
6. Business continuity plans ensuring testing availability during emergencies;
7. Professional liability insurance covering examination administration;
8. Financial stability and resources to fulfill contract obligations;
9. No conflicts of interest with test preparation companies or candidate recruiting organizations;
10. Commitment to non-discrimination and equal access principles.
...
1. **Testing Center Requirements:**
   - Minimum number of testing centers per state based on population;
   - Urban and rural geographic distribution ensuring reasonable candidate access;
   - Testing center hours of operation (minimum 6 days per week);
   - Physical security standards (surveillance, secure check-in, isolated testing rooms);
   - Technology requirements (computers, internet connectivity, backup power);
   - Staff training requirements;
   - Annual testing center audits;

2. **Online Proctoring Requirements:**
   - Proctoring methodology (live, recorded review, or AI-assisted);
   - Identity verification procedures;
   - Technical requirements communicated to candidates;
   - Technical support availability during testing;
   - Proctor training and certification;
   - Recording retention periods;
   - Privacy protections for candidate data;

3. **Score Reporting Requirements:**
   - **Provisional scores delivered immediately upon examination completion through automated scoring systems;**
   - **Final scores confirmed within the timeframe established by the Commission, considering psychometric validation, security review, and scoring verification requirements;**
   - Score reports provided to candidates, FCAO, and state election officials;
   - Comprehensive score reports including overall percentage and content area performance;
   - National percentile rankings;
   - Secure electronic transmission to authorized recipients;

4. **Security Requirements:**
   - Item bank access controls and encryption;
   - Candidate misconduct investigation procedures;
   - Security breach reporting (immediate notification to FCAO);
   - Regular security audits by independent assessors;
   - Employee background checks and confidentiality agreements;
   - Secure transmission of examination materials to testing centers;

5. **Accessibility Requirements:**
   - Disability accommodation request procedures;
   - Accommodation approval timelines (maximum 14 days);
   - Range of accommodations available (extended time, readers, scribes, assistive technology);
   - Accommodation training for testing center staff;
   - Alternate format examinations (large print, Braille, audio);

6. **Performance Standards and Remedies:**
   - Specific, measurable performance metrics;
   - Liquidated damages for breaches;
   - Termination provisions for persistent failures;
   - Transition procedures if contract is terminated;
   - FCAO rights to inspect facilities and audit operations.
...
3. Points are awarded as follows:
   ...
   - Matching questions: 1 point per correct match;
   - Brief constructed response questions: 1-3 points based on scoring rubric;
   - Short essay questions: 3-5 points based on scoring rubric;
   - Scenario analysis questions: 5-10 points based on scoring rubric;

4. All scoring rubrics shall be:
   - Developed by professional psychometricians;
   - Approved by supermajority vote of the Commission (6 of 9);
   - Made publicly available;
   - Applied consistently across all candidates;
   - Periodically reviewed and refined based on inter-rater reliability studies;

5. Constructed response and essay questions shall be scored by:
   - Trained raters who have completed standardized training;
   - At least two independent raters per response (blind scoring);
   - Adjudication process for discrepant scores;
   - Regular inter-rater reliability monitoring;
   - Periodic recalibration training.
...
4. Once a higher score is achieved, it immediately becomes the official score for all purposes including:
   - Ballot printing and sample ballots;
   - Official voter guides and election materials;
   - Public databases and score inquiries;
   - Media reports and candidate profiles;
   - All other official uses;

5. This highest-score rule applies to:
   - Initial examinations for new candidates;
   - Recertification examinations for incumbents;
   - All retakes regardless of reason;
   - Examinations taken in different election cycles;

6. Testing organizations and FCAO staff shall implement procedures ensuring:
   - Previous lower scores are not inadvertently disclosed;
   - Database systems automatically display only highest scores;
   - Score reports clearly indicate "Official Score: [highest percentage]";
   - Internal records distinguish between highest (official) and other scores for administrative purposes only.
...
1. **Provisional Score Report (Immediate):**
   - Overall percentage score based on automated scoring of objective questions;
   - Notice that score is provisional pending validation and final confirmation;
   - Estimated timeframe for final score confirmation as established by the Commission;
   - Ability to schedule retakes using provisional score;

2. **Final Score Report (Within Commission-Established Timeframe):**
   - Overall percentage score (rounded to nearest whole percentage);
   - Pass/fail status (N/A -- all candidates proceed regardless of score);
   - Date of examination;
   - Examination form identifier;
   - National percentile ranking among all candidates who have taken that examination type;
   - Comparison to mean and median scores;

3. **Content Area Performance:**
   - Percentage score for each tested content domain;
   - Identification of strengths and weaknesses;
   - Recommendations for study focus if retaking;

4. **Study Resources:**
   - Links to relevant practice materials;
   - Suggestions for content areas requiring additional preparation;
   - Information about retake procedures and scheduling;

5. **Official Use Statement:**
   - Confirmation that this score will be reported to election officials;
   - Explanation of highest-score rule for multiple attempts;
   - Information about score database and public disclosure.

**(6) Score Confirmation Standards**

1. The Commission shall establish official score confirmation timeframes based on:
   - Examination complexity and question types;
   - Psychometric validation requirements;
   - Security and integrity review procedures;
   - Testing organization capabilities;
   - Professional testing standards;

2. Timeframes shall be:
   - Published prominently on FCAO website and testing materials;
   - Communicated clearly to candidates at time of examination scheduling;
   - Reasonable in light of ballot access filing deadlines;
   - Subject to periodic review and adjustment based on operational experience;

3. The Commission may establish different timeframes for:
   - Examinations with only objective (multiple choice, true/false) questions;
   - Examinations including constructed response items requiring human scoring;
   - Peak examination periods near filing deadlines;
   - Routine examinations during non-election periods;

4. FCAO shall monitor actual score confirmation times and:
   - Report statistics in annual reports;
   - Identify delays and implement corrective actions;
   - Adjust published timeframes if operational realities differ from projections;
   - Strive for continuous improvement in turnaround speed while maintaining integrity;

5. Provisional scores shall include estimated confirmation timeframe and clear notice that provisional scores may be adjusted after official validation;

6. In cases where final score differs from provisional score, candidates shall be:
   - Notified immediately;
   - Provided explanation of adjustment;
   - Offered opportunity to review scoring and request reconsideration;
   - Informed of appeal procedures if appropriate.
...
1. **House FE Content Domains:**
   - Constitutional structure and separation of powers (15-20% of examination);
   - House legislative procedures and rules (20-25%);
   - Federal government organization and operations (15-20%);
   - Constitutional rights and civil liberties (10-15%);
   - Budget and appropriations process (10-15%);
   - Federal ethics laws and House ethics rules (10-15%);
   - Historical context of constitutional provisions (5-10%);

2. **Senate FE Content Domains:**
   - All House FE content domains with greater depth (40-50% of examination);
   - Senate-specific procedures (cloture, filibuster, unanimous consent) (15-20%);
   - Advice and consent responsibilities (treaties, appointments) (10-15%);
   - Impeachment trial procedures (5-10%);
   - Congressional oversight and investigation powers (10-15%);
   - Senate ethics rules and campaign finance regulations (5-10%);

3. **Presidential FE Content Domains:**
   - All Senate FE content domains with greater depth (30-40% of examination);
   - Executive authority and presidential powers (15-20%);
   - Commander-in-Chief responsibilities and military law (10-15%);
   - Foreign policy and diplomatic relations (10-15%);
   - Executive branch organization and Cabinet operations (10-15%);
   - Presidential appointment and removal powers (5-10%);
   - Administrative law and regulatory processes (5-10%);
   - Presidential ethics and emoluments clauses (5-10%);

4. Content domain weightings may be adjusted by the Commission based on:
   - Psychometric validation studies;
   - Subject matter expert recommendations;
   - Changes in office responsibilities;
   - Public feedback;
   - Professional testing standards;

5. All adjustments to content domains or weightings require supermajority approval (6 of 9 Commission members).

**(2) Item Bank Development**

1. FCAO shall maintain secure item banks containing examination questions for each office:
   - Minimum of 500 questions per content domain;
   - Multiple equivalent examination forms;
   - Regular addition of new questions;
   - Retirement of questions after specified usage;
   - Statistical analysis of question performance;

2. Item bank development procedures:
   - Subject matter experts draft questions following Commission-approved specifications;
   - Psychometricians review questions for technical quality;
   - Bias review panels assess questions for cultural fairness;
   - Commission approves questions by supermajority vote (6 of 9);
   - Questions undergo pilot testing before active use;
   - Statistical analysis ensures questions perform as intended;
   - Poor-performing questions are revised or retired;

3. Item bank security:
   - Access limited to authorized FCAO personnel and contractors;
   - Multi-factor authentication required;
   - All access logged and monitored;
   - Encryption of item banks in storage and transmission;
   - Regular security audits;
   - Immediate investigation of any suspected breaches;

4. Question retirement and public release:
   - Questions are retired after specified number of uses or time period;
   - Retired questions may be publicly released for study purposes;
   - Released questions remain the intellectual property of FCAO;
   - Public release enhances transparency and candidate preparation.

**(3) Biennial Updates**

1. Examinations shall be reviewed and updated every two years to ensure:
   - Accuracy reflecting current federal law;
   - Incorporation of recent Supreme Court decisions;
   - Updates for new statutory requirements;
   - Reflection of current governmental operations;
   - Alignment with professional psychometric standards;
   - Removal of outdated or obsolete content;

2. Update process:
   - Commission establishes biennial review schedule;
   - Subject matter experts identify necessary updates;
   - New questions are developed following standard procedures;
   - Outdated questions are retired;
   - Content domain weightings are reviewed;
   - Public comment period precedes final approval;
   - Updated examinations receive supermajority approval (6 of 9);

3. Substantial changes to examination structure require:
   - Extended public comment period (90 days);
   - Validity studies demonstrating new version measures same constructs;
   - Transition period where candidates may choose old or new version;
   - Clear communication to candidates about changes;

4. Minor updates (correcting errors, updating statutory citations) may be implemented without formal public comment but must be documented and reported in annual reports.
...
1. **Complete Practice Examinations:**
   - Full-length practice exams for each office (House FE, Senate FE, Presidential FE);
   - Same format, question types, and time limits as official examinations;
   - Answer keys with explanations;
   - Scoring guides;
   - At least two complete practice exams per office available at all times;

2. **Study Guides:**
   - Content outlines showing tested topics;
   - Recommended study resources (textbooks, government documents, online materials);
   - Key concepts and definitions;
   - Constitutional provisions most frequently tested;
   - Sample questions with detailed explanations;

3. **Question Banks:**
   - Retired questions released for public study;
   - Organized by content domain;
   - Difficulty ratings indicated;
   - Explanations of correct answers;
   - Regularly updated with newly retired questions;

4. **Tutorial Videos:**
   - Explanation of examination format and scoring;
   - Test-taking strategies;
   - Navigation of testing interface;
   - What to expect on examination day;
   - Disability accommodation procedures;

5. **All materials available free of charge on FCAO website and in accessible formats.**
...
1. FCAO shall ensure testing centers are available in:
   - All 50 states with population-based distribution;
   - U.S. territories (Puerto Rico, U.S. Virgin Islands, Guam, American Samoa, Northern Mariana Islands);
   - Washington, D.C.;
   - International locations where feasible for candidates residing abroad;

2. Testing center distribution standards:
   - States with population under 1 million: minimum 3 testing centers;
   - States with population 1-5 million: minimum 5 testing centers;
   - States with population 5-10 million: minimum 10 testing centers;
   - States with population over 10 million: minimum 15 testing centers;
   - Additional centers in rural areas ensuring no candidate must travel more than 100 miles to nearest center;

3. Testing centers must:
   - Comply with Americans with Disabilities Act accessibility requirements;
   - Provide quiet, secure testing environments;
   - Offer testing appointments at least 6 days per week;
   - Provide evening and weekend appointments;
   - Maintain backup power and internet connectivity;
   - Have trained proctoring staff;

4. Online proctored examinations provide additional access for:
   - Candidates in remote locations;
   - Candidates with scheduling constraints;
   - Candidates preferring home testing environment;
   - International candidates where testing centers unavailable.
...
3. **Physical Accommodations:**
   ...
   - Permission to bring medical devices or supplies;

4. **Assistance:**
   - Readers for candidates with visual impairments;
   - Scribes for candidates with mobility impairments;
   - Sign language interpreters;
   - Other human assistance as appropriate;

5. **Technology Accommodations:**
   - Screen magnification software;
   - Speech-to-text software;
   - Alternative input devices;
   - Compatibility with candidate's own assistive technology;

6. Testing center modifications as needed for specific disabilities.

**(3) Accommodation Procedures**

1. **Request Process:**
   - Candidates submit accommodation requests when scheduling examinations;
   - Requests include documentation of disability from qualified professional;
   - Documentation describes functional limitations and recommended accommodations;
   - FCAO reviews requests and approves appropriate accommodations;

2. **Approval Timeline:**
   - Standard review: accommodation approved or denied within 14 days of receipt;
   - Expedited review available for candidates with approaching ballot access deadlines;
   - Provisional accommodations may be granted pending documentation review;

3. **Appeals:**
   - Candidates may appeal accommodation denials;
   - Appeals reviewed by Commission-appointed disability accommodation specialist;
   - Appeal decisions made within 7 days;
   - Further appeal to Commission available in extraordinary circumstances;

4. **Confidentiality:**
   - Accommodation requests and disability documentation kept confidential;
   - Not disclosed to election officials or included in public score reports;
   - Scores from accommodated administrations not flagged or distinguished;
   - Testing organizations bound by confidentiality requirements;

5. **No Additional Fees:**
   - Accommodations provided at no additional charge;
   - FCAO absorbs costs of accommodations;
   - No candidate penalized financially for needing accommodations.
...
1. **Testing Center Security:**
   ...
   - Biometric identity confirmation (fingerprint or palm scan);
   - Prohibition on personal items in testing area (phones, bags, notes);
   - Secure storage lockers for personal belongings;
   - Video surveillance of testing areas;
   - Audio monitoring for suspicious activity;
   - Secure check-in and check-out procedures;
   - Scratch paper provided and collected;
   - Randomized seating assignments;
   - Proctors trained in security procedures;

2. **Online Proctoring Security:**
   - Multi-factor identity verification before examination start;
   - Live proctoring or AI-assisted monitoring during examination;
   - 360-degree room scans before testing;
   - Continuous video and audio recording;
   - Screen recording to detect unauthorized assistance;
   - Secure browser preventing access to other applications;
   - Automatic flagging of suspicious behaviors;
   - Human review of flagged sessions;

3. **Examination Content Security:**
   - Item banks encrypted and access-controlled;
   - Different examination forms for each administration;
   - Question randomization within forms;
   - Examination materials destroyed after use at testing centers;
   - Prohibition on removing examination materials;
   - Non-disclosure agreements for all personnel with access;
   - Regular security audits of systems and procedures.

**(2) Item Bank Protection**

1. Access to item banks limited to:
   - Commission members (view only, no copying);
   - Authorized FCAO psychometric staff;
   - Contracted item writers under non-disclosure agreements;
   - Testing organization personnel on need-to-know basis;

2. Technical security measures:
   - Encryption of item banks at rest and in transit;
   - Multi-factor authentication for access;
   - Logging of all access attempts and views;
   - Automatic alerts for unusual access patterns;
   - Regular penetration testing;
   - Incident response plans for breaches;

3. Physical security measures:
   - Secure servers in access-controlled facilities;
   - Backup systems in geographically separated locations;
   - Disaster recovery procedures;
   - Regular security audits by independent assessors;

4. Legal protections:
   - Item banks designated as confidential trade secrets;
   - Legal action against unauthorized disclosure;
   - Injunctions available to prevent dissemination;
...
1. **Prohibited Conduct:**
   ...
   - Using prohibited materials (notes, electronic devices);
   - Copying or reproducing examination content;
   - Falsifying identity;
   - Disruptive behavior;
   - Attempting to access secure item banks;
   - Sharing examination content with others;
   - Using proxy test-takers;

2. **Investigation Procedures:**
   - Testing organizations report suspected misconduct immediately;
   - FCAO investigates allegations;
   - Candidates notified of allegations and given opportunity to respond;
   - Evidence reviewed (video recordings, proctor reports, statistical analysis);
   - Commission reviews findings and determines sanctions;

3. **Sanctions:**
   - Score invalidation for confirmed misconduct;
   - Prohibition from retaking examination for 1 year;
   - Permanent prohibition for egregious violations (proxy testing, item bank theft);
   - Referral to law enforcement for criminal conduct;
   - Public disclosure if candidate proceeds to ballot despite invalidated score;

4. **Appeals:**
   - Candidates may appeal misconduct findings to Commission;
   - Appeals heard by panel of three Commission members;
   - Final decision by full Commission vote;
   - Further judicial review available under Administrative Procedure Act;

5. **Statistical Detection:**
   - Unusual answer patterns flagged for investigation;
   - Score gains inconsistent with learning flagged;
   - Similarity of answers among candidates in same location flagged;
   - Forensic analysis conducted by psychometricians.
...
1. There are authorized to be appropriated such sums as necessary for FCAO establishment and initial operations, including:
   ...
   - Executive Director and initial staff hiring;
   - Office space, equipment, and technology infrastructure;
   - Examination development and validation studies;
   - Item bank creation and psychometric review;
   - Testing organization procurement and contracting;
   - Public education and outreach materials;
   - Website development and database systems;

2. Initial appropriations shall cover FCAO operations for the first 24 months following enactment;

3. Estimated initial appropriations requirement: $25-35 million for establishment phase, covering:
   - Year 1: $15-20 million (Commission appointment, staff hiring, examination development, infrastructure);
   - Year 2: $10-15 million (testing organization contracts, pilot testing, final preparations);

4. Appropriations shall be available until expended and may be used across fiscal years as needed for effective implementation.
...
2. This independent funding structure:
   - Insulates FCAO from appropriations politics and partisan budget battles;
   - Follows proven models of other independent agencies (FDIC, NRC, SEC, OCC);
   - Ensures stable, predictable funding for continuous operations;
   - Protects against attempts to defund or constrain FCAO through budget process;
   - Allows multi-year financial planning;

3. Congress may not reduce or eliminate FCAO operational funding after the transition to fee-based funding, except through legislation specifically amending this section;

4. FCAO retains authority to request supplemental appropriations for:
   - Major capital improvements;
   - Expansion of testing center networks;
   - Enhanced public education campaigns;
   - Response to emergencies affecting examination administration;
   - Other extraordinary expenses beyond normal operations.

**(3) Fee Structure**

1. FCAO shall establish examination fees sufficient to cover operational costs including:
   - Commission and staff compensation;
   - Testing organization contracts;
   - Testing center operations;
   - Examination development and updates;
   - Psychometric validation studies;
...
2. Maximum examination fees:
   - House FE: $500 per examination attempt;
   - Senate FE: $750 per examination attempt;
   - Presidential FE: $1,000 per examination attempt;

3. These maximum fees may be adjusted annually for inflation using the Consumer Price Index;

4. FCAO shall set actual fees at levels necessary to sustain operations while remaining accessible:
   - Fees shall not exceed maximums specified in this subsection;
   - Fees shall be uniform nationwide (no geographic variation);
   - Fees shall be the same for testing center and online proctored examinations;
   - Fees shall cover all accommodations without surcharges;

5. Fee revenue shall be deposited in a FCAO Operating Fund established in the Treasury:
   - Fund remains available without fiscal year limitation;
   - FCAO has direct spending authority from the Fund;
   - Fund may accumulate reserves for contingencies (maximum 150% of annual operating costs);
   - Excess reserves may be used to reduce examination fees;

6. FCAO shall publish annual budgets and financial reports showing:
   - Revenue from examination fees;
   - Expenditures by category;
   - Reserve fund balances;
   - Fee adequacy analysis;
   - Any proposed fee adjustments.
...
2. Candidates qualify for fee waivers if:
   - Annual income is below 200% of federal poverty level;
   - Currently receiving means-tested federal benefits (SNAP, Medicaid, SSI);
   - Serving as an unpaid volunteer in government or nonprofit work;
   - Other circumstances demonstrating inability to pay without undue hardship;

3. Fee waivers are granted at FCAO discretion based on:
   - Documentation of income or benefit receipt;
   - Candidate attestation under penalty of perjury;
   - Other evidence of financial need;

4. Fee waivers cover:
   - Full examination fee;
   - Unlimited retakes during the election cycle;
   - All accommodations if needed;

5. Fee waiver requests are confidential and not disclosed publicly;

6. FCAO shall fund fee waivers from:
   - Operating reserves;
   - Supplemental appropriations if needed;
   - Modest increases in standard fees to cross-subsidize waivers;

7. Fee waiver denials may be appealed to the Commission;

8. FCAO shall ensure fee waivers do not create barriers to ballot access for qualified candidates of limited financial means.
...
2. Appointment schedule:
   - President nominates 3 members within 90 days of enactment;
   - Senate holds confirmation hearings within 60 days of nomination;
   - Senate votes on confirmation within 30 days of hearings;
   - Chief Justice appoints 2 members within 120 days of enactment;
   - House Speaker appoints 2 members within 120 days of enactment;
   - Senate Majority Leader appoints 2 members within 120 days of enactment;

3. If any appointing authority fails to make appointments within 6 months, remaining appointed members may proceed as Commission with reduced membership until all positions are filled;

4. Initial term staggering (determined by lot at first meeting):
   - Three members: 2-year initial terms;
   - Three members: 4-year initial terms;
   - Three members: 6-year initial terms;

5. Commission holds first meeting within 60 days of final member appointment or within 7 months of enactment, whichever is earlier.
...
2. Development process:
   - Establish examination development committees with subject matter experts;
   - Draft content outlines and specifications;
   - Create initial item pools;
   - Conduct bias reviews and psychometric analysis;
   - Develop scoring rubrics;
   - Create practice examinations;
   - Commission approval by supermajority vote (6 of 9);

3. Public comment period of 90 days shall precede final examination approval;

4. Commission shall:
   - Review and consider all public comments;
   - Make adjustments based on substantive feedback;
   - Publish responses to major comment themes;
   - Finalize examinations within 18 months of enactment;

5. Practice examinations and study materials shall be publicly available at least 12 months before examinations become mandatory for ballot access;

6. Pilot testing of examinations:
   - Voluntary pilot testing with interested individuals;
   - Statistical analysis of pilot results;
   - Refinement based on pilot data;
   - Establishment of scoring scales and percentile rankings.
...
2. RFP shall specify:
   - Testing center network requirements;
   - Online proctoring capabilities;
   - Security standards;
...
3. Proposal evaluation criteria:
   ...
   - Testing center geographic coverage (20%);
   - Cost and fee structure (15%);
   - Security protocols (10%);
   - Accommodation capabilities (10%);
   - References and past performance (5%);

4. Contract awards within 15 months of enactment;

5. Testing infrastructure operational at least 6 months before examinations become mandatory;

6. Testing organization readiness verification:
   - Testing center inspections;
   - Technology systems testing;
   - Staff training completion;
   - Security protocol implementation;
   - Dry-run examinations;
   - Commission certification of readiness.
...
2. Coordination activities:
   - Briefings on examination purpose and non-qualifying nature;
   - Training on score disclosure requirements;
   - Model ballot language and formatting;
   - Timeline coordination for filing deadlines;
   - Procedures for receiving candidate scores;
   - Integration with existing ballot access processes;

3. FCAO shall provide states with:
   - Technical assistance for ballot printing systems;
   - Electronic score transmission systems;
   - Voter education materials;
   - Frequently asked questions;
   - Direct support contacts;

4. State election official training:
   - Regional training sessions;
   - Webinars and online resources;
   - Written guidance documents;
   - Ongoing technical support;

5. FCAO and FEC shall coordinate state outreach to ensure consistent messaging.
...
2. Upon establishment of a constitutional Commission:
   - All FCAO authorities, responsibilities, and duties transfer to the constitutional Commission;
   - All examination records, item banks, and historical data transfer;
   - All contracts with testing organizations transfer or are honored until completion;
   - All ongoing operations continue without interruption;
   - The FCAO Commission's functions are assumed by the constitutional Commission;

3. FCAO shall cooperate fully with the constitutional Commission during transition;

4. Transition timeline:
   - Constitutional Commission becomes operational on date specified in establishing amendment or legislation;
   - FCAO continues operations for 180 days after constitutional Commission operational date;
   - During 180-day transition period, constitutional Commission assumes increasing responsibility;
   - FCAO sunsets 180 days after constitutional Commission becomes operational;

5. Commission members serving at time of transition:
   - May complete their terms as members of the constitutional Commission if appointed to it;
   - Otherwise, terms end when FCAO sunsets;
   - Entitled to compensation through end of service;
   - May assist constitutional Commission with transition as consultants.
...
2. Candidate scores obtained under FCAO:
   - Transfer to constitutional Commission databases;
   - Remain valid for ballot access purposes;
   - Continue to satisfy examination requirements;
   - Are not invalidated by transition;

3. Recertification schedules established under FCAO continue under constitutional Commission unless modified;

4. Candidates who completed examinations under FCAO are not required to retake examinations solely due to transition;

5. Constitutional Commission may:
   - Revise examination content going forward;
   - Update scoring methodologies;
   - Modify recertification requirements;
   - But shall not retroactively invalidate FCAO-administered scores.

**(3) Institutional Knowledge Transfer**

1. FCAO shall prepare comprehensive transition documentation including:
   - Examination development methodologies and standards;
   - Item bank organization and psychometric properties;
   - Administration procedures and lessons learned;
   - Security protocols and incident response procedures;
   - Statistical analyses and validity studies;
   - Testing organization contract management practices;
   - Accommodation procedures and best practices;
   - Technology systems documentation;
   - Financial management procedures;
   - Recommendations for constitutional Commission operations;

2. Transition documentation shall be provided to constitutional Commission no later than 90 days after it becomes operational;

3. FCAO staff and contractors shall:
   - Brief constitutional Commission members and staff;
   - Provide technical assistance during transition;
   - Transfer institutional knowledge;
   - Facilitate smooth operational handoff;

4. Testing organization contracts shall include provisions for:
   - Transition to constitutional Commission oversight;
   - Continuity of services during transition;
   - Minimal disruption to candidates;
   - Cooperation with new oversight authority.
...
2. This principle is inviolable and may not be modified, waived, or undermined by:
   - Any legislation;
   - Any regulation or administrative rule;
   - Any court decision;
   - Any executive order;
   - Any state law or local ordinance;
   - Any political party rule;
   - Any contractual requirement;
   - Any other governmental or private action;

3. The non-qualifying nature of FCAO examinations is a fundamental, defining characteristic that cannot be altered while maintaining examination legitimacy and public trust.
...
3. No minimum score may be established for:
   ...
   - Receipt of campaign finance benefits;
   - Any other electoral advantage or requirement;

4. Voters retain complete sovereignty to elect any constitutionally qualified candidate regardless of examination performance;

5. The sole purpose of examinations is to provide voters with objective information for their consideration in making electoral choices;

6. FCAO, state officials, political parties, and all other actors must respect and preserve this absolute democratic access guarantee.
...
8. Discriminate against candidates based on examination scores in:
   - Media coverage access;
   - Voter guide inclusion;
   - Party endorsement decisions (except as one factor among many);
   - Political advertising opportunities;
   - Any other electoral resource or opportunity;

9. Pressure candidates to withdraw based on examination performance;

10. Stigmatize, penalize, or create barriers for low-scoring candidates beyond voter information disclosure.
...
2. Upon showing that any authority has used examination scores as qualification criteria, courts shall:
   - Issue preliminary injunctions within 48 hours restoring candidate rights;
   - Grant permanent injunctions prohibiting future violations;
   - Award attorney's fees and costs to prevailing candidates;
   - Order corrective actions (ballot reprinting, debate inclusion, etc.);

3. Preliminary injunctions are mandatory upon showing:
   - Candidate meets constitutional qualifications for office;
   - Candidate completed FCAO examination (regardless of score);
   - Candidate denied ballot access or electoral opportunity based on examination score;
   - Harm is imminent or ongoing;

4. No bond or security is required for preliminary injunctions under this subsection;

5. Expedited appeals:
   - Appeals may be taken directly to appropriate circuit court;
   - Circuit courts shall rule within 14 days;
   - Supreme Court review available on emergency basis;

6. Jurisdiction:
   - Federal district courts have original jurisdiction;
   - Venue proper in district where violation occurred;
   - Cases assigned expedited status on court dockets;
...
7. Remedies available:
   ...
   - Nominal damages for violation of constitutional rights;
   - Prospective relief preventing future violations;

8. Standing:
   - Candidates have standing to challenge violations affecting them;
   - Voters have standing to challenge violations affecting candidate choices;
   - FCAO has standing to challenge violations of examination integrity;
   - Public interest organizations have standing to challenge systemic violations.
...
1. **Civil Penalties:**
   - Fines against officials who violate non-qualifying principle;
   - Penalties up to $10,000 per violation;
   - Each affected candidate constitutes separate violation;
   - Penalties paid to harmed candidates as compensation;

2. **Funding Conditions:**
   - State election administration grants conditioned on compliance;
   - Federal funds may be withheld from jurisdictions violating non-qualifying principle;
   - Restoration of funds upon compliance and corrective action;

3. **Enhanced Remedies:**
   - Treble damages for willful violations;
   - Punitive damages for egregious or repeated violations;
   - Mandatory minimum attorney's fees awards;
   - Expedited remedial processes;

4. **Criminal Penalties:**
   - Criminal prosecution for willful, systematic violations;
   - Misdemeanor charges for officials knowingly violating non-qualifying principle;
   - Felony charges for conspiracies to exclude candidates based on scores;
   - Fines and imprisonment up to 1 year for misdemeanors, 5 years for felonies;

5. **Enforcement Authority:**
   - Department of Justice authority to investigate and prosecute violations;
   - Federal Election Commission authority to enforce through civil actions;
   - FCAO authority to refer violations to DOJ;
   - Private attorneys general provisions enabling citizen enforcement.
...
1. The Government Accountability Office shall conduct annual audits of FCAO examining:
   - Examination validity, reliability, and fairness;
   - Compliance with psychometric professional standards;
   - Administration procedures and security protocols;
   - Absence of ideological bias or partisan content;
   - Cultural fairness and demographic group performance analysis;
   - Adherence to non-qualifying transparency principles;
   - Financial management and fee structure adequacy;
   - Testing organization performance and contract compliance;
   - Disability accommodation effectiveness;
   - Score reporting accuracy and adherence to established timeframes;

2. Audit methodology:
   - Independent psychometric review of examinations;
   - Statistical analysis of score distributions and trends;
   - Demographic fairness analysis (performance by race, ethnicity, gender, age);
   - Content review for partisan bias;
   - Security assessment;
   - Interviews with candidates, testing center staff, Commission members;
   - Review of Commission meeting minutes and decisions;
   - Financial audit of revenues, expenditures, reserves;

3. GAO shall have full access to:
   - Examination items and scoring rubrics;
   - Statistical data on candidate performance;
   - Commission deliberations and records;
   - Testing organization contracts and performance data;
   - Financial records;
   - Security incident reports;
   - Any other information necessary for comprehensive audit;

4. FCAO shall cooperate fully with GAO audits and provide:
   - Timely access to all requested information;
   - Staff assistance and briefings;
...
2. Reports shall include:
   ...
   - Detailed findings on each audit area;
   - Recommendations for improvements;
   - Assessment of FCAO compliance with statutory requirements;
   - Trends over time in examination quality and administration;
   - Comparative analysis with other professional examination programs;
...
4. FCAO shall respond formally to each GAO report within 90 days, indicating:
   - Agreement or disagreement with findings;
   - Actions taken or planned in response to recommendations;
   - Timeline for implementing accepted recommendations;
   - Explanation for any recommendations not accepted;

5. FCAO responses shall be published alongside GAO reports;

6. GAO shall conduct follow-up reviews in subsequent audits verifying implementation of accepted recommendations.
...
2. Briefings shall occur:
   - Annually following report issuance;
   - Upon request by committee chairs;
   - In response to concerns raised by members of Congress;
   - Before major FCAO policy changes;

3. Briefings shall cover:
   - Key audit findings and recommendations;
   - FCAO performance trends;
   - Concerns requiring congressional attention;
   - Potential legislative improvements;
   - Comparison with best practices in professional testing;

4. Committee staff shall have access to detailed audit workpapers and supporting documentation;

5. Congressional oversight hearings may be held based on GAO findings.
...
1. Examination content decisions, specific questions, scoring methodologies, and content domain weightings are not subject to judicial review except for claims of:
   - Systematic discrimination against protected classes (race, ethnicity, national origin, gender, religion, disability);
   - Constitutional violations of fundamental rights;
   - Arbitrary and capricious action demonstrating complete abandonment of professional standards;

2. Courts shall give substantial deference to Commission expertise in:
   - Psychometric standards and testing validity;
   - Content domain selection and weighting;
   - Question difficulty calibration;
   - Scoring rubric development;
   - Professional assessment practices;

3. Challenges to examination content must show:
   - Clear violation of statutory requirements;
   - Systemic pattern of discrimination;
   - Fundamental departure from professional standards;
   - Actual harm to identifiable protected class;

4. Isolated questions or minor errors do not constitute grounds for invalidating entire examinations;

5. Burden of proof on challengers to demonstrate examination invalidity.
...
2. Reviewable procedural matters include:
   - Candidate misconduct determinations;
...
3. Standard of review: arbitrary, capricious, abuse of discretion, or otherwise not in accordance with law;

4. Courts may order:
   - Remand for further proceedings;
   - Correction of procedural errors;
   - Candidate relief (score reinstatement, fee refunds, accommodation approval);
   - Process improvements.

**(3) Emergency Relief Standards**

1. Courts may grant emergency relief only where:
   - Examination administration failures threaten to deny ballot access to qualified candidates through no fault of their own;
   - Testing center closures prevent candidates from completing examinations;
   - Score reporting failures prevent timely ballot printing;
   - Security breaches compromise examination integrity requiring suspension;
   - Other circumstances creating imminent, irreparable harm;

2. Emergency relief may include:
   - Extension of examination deadlines;
   - Alternative testing arrangements;
   - Provisional ballot access pending score resolution;
   - Temporary suspension of examination requirement if administration failures are widespread;

3. Emergency relief shall not:
   - Override non-qualifying principle;
   - Excuse candidates from completing examinations;
   - Invalidate properly administered examinations;
   - Create exceptions to examination requirements except for FCAO operational failures;

4. Courts shall act expeditiously on emergency motions, ruling within 48-72 hours.
...
5. Remedies may include:
   - Mandatory injunctions requiring score display;
   - Ballot reprinting if necessary;
   - Supplemental voter information if reprinting impractical;
   - Corrective measures for future elections;
   - Attorney's fees and costs;

6. States may not avoid disclosure requirements through:
   - Font size manipulation;
   - Obscure placement;
   - Separate document requirements;
   - Technical formatting excuses;
   - Any other method diminishing score visibility.
...
The examination requirements of this Title shall take effect beginning with the Second CMA Election.

#### (b) Development and Validation Deadline

The Federal Candidate Assessment Office shall complete development, pilot testing, validation, and certification of all examinations no later than eighteen (18) months before the Second CMA Election.

#### (c) Administration Deadline

The Federal Candidate Assessment Office shall make such examinations available for administration to candidates no later than twelve (12) months before the Second CMA Election, and shall provide sufficient testing windows to ensure fair access and timely score reporting.

#### (d) First CMA Election Exemption

No candidate shall be required to complete an FCAO examination for the First CMA Election. Ballots for the First CMA Election shall not include FCAO score designations.

#### (e) Agency Establishment Timeline

Notwithstanding the effective date in subsection (a), the establishment of the Federal Candidate Assessment Office, appointment of the FCAO Commission, and all administrative preparations shall proceed immediately upon enactment as specified in Section 504, ensuring the agency is fully operational in advance of the Second CMA Election.
...
2. **First CMA Election Provisions**: Taking effect at the First CMA Election (Tier 2)
...
This section supersedes 2 U.S.C. Ãƒâ€šÃ‚Â§ 4501 (congressional pay adjustment) to the extent inconsistent with this section.
...
(2) Within 180 days of the establishment of the Electoral Science Office, the Federal Election Commission and the Electoral Science Office shall enter into a memorandum of understanding governing the matters specified in Section 409(i)(3).
...
2. **Tier 2 (First CMA Election):** Titles I (Federal Ballot Access Standards), II (Federal Party Recognition), III (House Membership Expansion), and IV (Multi-Member Districts and STAR Voting) take effect as of the First CMA Election.

3. **Tier 3 (Second CMA Election):** Title V (Non-Qualifying Federal Office Examinations) takes effect as of the Second CMA Election.
...
2. **"First CMA Election"**: The first regularly scheduled general election for Congress at which the provisions of Titles I, II, III, and IV of this Act take effect, determined as follows: it shall be the second regularly scheduled general election for Congress occurring after the date of enactment, except that if such second election occurs less than eighteen (18) months after enactment, the First CMA Election shall instead be the third regularly scheduled general election for Congress occurring after the date of enactment.

3. **"Second CMA Election"**: The first regularly scheduled general election for Congress occurring after the First CMA Election.

4. **"Transition Cycle 1"**: The First CMA Election (corresponding to Title IV, Section 402(a)).
...
1. **Census Independence**: House expansion timing under Title III operates on the schedule established in Section 301 (initial expansion at First CMA Election, biennial increases thereafter) and is independent of decennial census timing.
...
This Act may be cited as the "Congressional Modernization Act," "CMA," or the "Restoring Competition to American Elections Act."
...
"Adjustable parameters" means the technical elements of STAR and STAR-PR voting methods specified in Section 409(d)(1) that may be modified through the technical review process established in Section 409, including quota calculation formulas, reweighting methodology, seat allocation sequences, tie-breaking procedures, rounding and remainder handling, and audit and verification protocols.

#### (c) Immutable Statutory Elements

"Immutable statutory elements" means the voter-facing guarantees specified in Section 409(c)(1) that may not be modified except by Act of Congress, including the 0-5 star scoring range, ballot interface consistency, universal scoring permission, unscored treatment, single-winner STAR structure, and proportional outcome requirement.

#### (d) Technical Modification

"Technical modification" means any change to adjustable parameters proposed by the Electoral Science Office and approved through the process established in Section 409(g), which takes effect unless disapproved by joint resolution of Congress.
...
The critical innovation in CMA is **Title VI: Transition, Compensation, and Implementation**, which addresses the fundamental political economy problem facing electoral reforms: incumbents must vote away their own advantages.
...
**Tier 2 -- First CMA Election Provisions:**
...
This structure ensures members receive substantial immediate benefits while democratic reforms launch at the First CMA Election as an integrated system, aligning individual incentives with systemic reform objectives.
...
CMA's structure addresses the "turkey voting for Thanksgiving" problem through:
...
This accelerated timeline ensures reform on a human timescale -- members who vote for CMA will see results during their careers, and voters will experience tangible improvements in representation quality within a single political generation.
...
- **First CMA Election:** Candidates exempt; no FCAO scores on ballots
- **Second CMA Election:** Full FCAO requirements take effect
...
- **FCAO operates via statute** (Title V of CMA)
...
1. Pass CMA with FCAO as statutory independent agency
