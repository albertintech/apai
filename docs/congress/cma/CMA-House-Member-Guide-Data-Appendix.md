...
This appendix provides tabular reference data supporting the *CMA House Member Guide*. It catalogs financial provisions, electoral system changes, and implementation timelines.

**For strategic interpretation and adaptation guidance**, see the primary document: *CMA House Member Guide*.
...
| **Tier 2** | I, II, III, IV | First CMA Election | Ballot access, party recognition, House expansion, electoral reform |
| **Tier 3** | V | Second CMA Election | FCAO examinations |

**Definitions:**

- **First CMA Election**: Second general election after enactment (18-month minimum)
- **Second CMA Election**: First general election after First CMA Election
- **Full Implementation**: Fifth election after Transition Cycle 1 (~10-12 years from First CMA Election)
...
### Conditional Benefits (Tier 2 -- First CMA Election)
...
| Metric | Current System (10-year House career) | CMA System (10-year House career) |
|--------|--------------------------------------|----------------------------------|
...
|------------|-----------|-------------|
| Anti-Retaliation | Salary/benefits/privileges cannot be reduced based on CMA vote | Supermajority protection + severability |
...
### Transition Protections (First CMA Election through Full Implementation)
...
| Exam Development Complete | 18 months before Second CMA Election |
| Exams Available to Candidates | 12 months before Second CMA Election |
| Scores Appear on Ballots | Second CMA Election onward |
| **First CMA Election Exemption** | No FCAO requirement; no scores on ballots |
...
| First CMA Election (~2028) | 510 | +75 | ~657,000:1 |
...
### Scenario Analysis (assuming 2026 enactment, 2028 First CMA Election)
...
| FCAO Examinations | Apply (Second CMA Election) | Apply (Second CMA Election) |
...
|-----------|---------------|
| Initial Expansion | 510 seats at First CMA Election |
...
| Effective Date | Second CMA Election |
...
| MRA Enhancement | +35% at First CMA Election | N/A |
