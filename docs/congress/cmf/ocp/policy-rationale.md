...
> 📄 [Download this document](https://github.com/albertintech/apai/blob/main/docs/congress/cmf/ocp/policy-rationale.md) (opens on GitHub -- click the ⬇ download button)
