...
1. Ballot access requirements: Who may compete for office
2. Voting methods: How voters express their preferences (plurality, ranked-choice, score-based, etc.)
...
1. "Manner" includes vote counting procedures: *Arizona State Legislature* explicitly includes "counting of votes" within "manner of holding elections."

2. No constitutionally mandated voting method: The Constitution nowhere specifies plurality voting, ranked-choice voting, or any other method. Plurality voting is common law tradition, not constitutional requirement.

3. Historical flexibility: Congress and states have experimented with various voting methods throughout American history, including cumulative voting (Illinois, 1870-1980), approval voting (various localities), and ranked-choice voting (Maine, Alaska, various cities).

4. Administrative detail: The specific mathematical formula for tabulating votes (plurality, majority runoff, score-then-runoff, etc.) is quintessentially procedural -- exactly what "manner" encompasses.
...
1. Ballot format is "manner" regulation: What appears on ballots is quintessentially procedural.

2. Information provision, not restriction: Joint Endorsement Lists expand information available to voters without restricting ballot access or party rights.

3. No compelled speech concern: Parties choose whether to endorse; the requirement merely displays their voluntary endorsements.

4. Distinguishable from fusion voting challenges: *Timmons v. Twin Cities Area New Party* (1997) addressed state authority to prohibit fusion (multiple party nominations with vote aggregation). The Act's Joint Endorsement Lists are different -- candidates appear once, not multiple times; no vote aggregation across party lines occurs; the system displays endorsements, not nominations; and the provision is a federal statute under Elections Clause authority, not a state law challenge.
...
1. Direct Elections Clause power: Ballot access requirements determine who may compete in elections -- plainly within "manner" regulation.

2. Established precedent: Federal courts routinely evaluate state ballot access requirements under constitutional standards. Congressional authority to set those standards directly is a fortiori.

3. Preemption is explicit: The Elections Clause grants the power to "alter" state regulations. Replacing fifty different state ballot access regimes with uniform federal standards is a textbook exercise of this authority.
