...
In most of the country, the race that decides who represents you in Congress is not the one held in November. It is the primary — a low-turnout election, held months earlier, where a narrow slice of the electorate picks the candidates everyone else is handed in the fall. Primary turnout often runs around a fifth of eligible voters, and the people who do show up tend to be the most committed partisans on each side. By the time the general election arrives, the menu has already been set by someone else, and in most districts the real contest was settled the moment the primary ended.
...
## The Pre-Filtered Field

Most congressional seats in the United States are not genuinely contested in November. More than 90 percent of House races are effectively decided before a single general-election vote is cast — not because voters have made their choice, but because the district leans far enough one way that the primary winner faces no real competition in the fall. Heading into 2026, only about eighteen of the 435 House seats — roughly four percent of the chamber — were rated as genuine toss-ups.

The structural effect is straightforward. In a district where the general election is not competitive, the primary is the only election that matters. And primaries draw a fraction of the electorate — often below a fifth of registered voters, skewing toward the most ideologically committed on each side. The representative who takes office was chosen, in practical terms, by the narrow group that showed up on primary day. Everyone else ratified a decision someone else had already made. The November ballot offers a choice; it just doesn't always offer a meaningful one.

This is not a story about bad voters or bad candidates. It is what a system produces when it funnels the decisive choice through a low-participation election and hands the result to the broader electorate as a near-settled matter. The voter who shows up in November and feels that neither option represents them is not imagining the problem — the field was narrowed by a process they likely had no part in, and the choices that survived may reflect the priorities of the primary electorate rather than the district as a whole. The question is whether the field that reaches voters in November can be opened up — and whether the system can handle a wider field without breaking.

---

## Adjusting the Gate — and Its Limits

The instinct behind most attempts to fix this is a good one: if the primary is too narrow, broaden it. Let unaffiliated voters take part. Let registered voters of any party participate. Advance more than one candidate to the general election. These adjustments share a goal — making the decisive early election more inclusive — and they have genuine appeal.

But the deeper question is whether widening who passes through the gate is the same as removing the gate. Even the most inclusive primary is still a preliminary round that narrows the field before the full electorate sees it. The state still funds it. The state still enforces its result by keeping the candidates who lost off the November ballot. As long as the gate exists, someone is deciding — before the general election — which candidates voters get to consider. Widening who votes in the primary only changes which fraction of the electorate does the pre-selecting.

The move the Act makes is not to adjust the gate. It is to take the state out of the gatekeeping business for congressional elections entirely. Instead of asking which voters should be allowed to narrow the field, it asks why the state is narrowing the field at all. The state's job is to run the November election; deciding which qualified candidates appear on it belongs to the voters who show up for it — all of them, not the subset who showed up earlier. That is the design principle behind a full field on a single ballot: not a reformed primary, but a single election, where the full electorate meets the full field and the counting method finds the winner from among all of them.
...
### "Won't the ballot be chaos with twenty candidates?"

This is the most natural worry, and its premise is real: under the pick-one system most Americans know, a twenty-candidate ballot would be unworkable. Votes would scatter, and someone could take office with fifteen percent support. That experience is what makes the concern feel urgent.

But the counting method changes the math entirely. Recall that voters score every candidate they care about rather than choosing just one. A voter with strong feelings about three candidates and mild preferences about two more can express all of it on a single ballot, and nothing is wasted. The count uses every score to find the two most broadly supported candidates, then settles the race between them. The field can be large without the ballot becoming chaos, because the method was built from the ground up to handle a large field. The primary existed to solve a problem the counting method now solves directly.
...
The concern assumes the primary reliably filters out fringe candidates before the general election. Sometimes it does. Sometimes it does the opposite — rewarding the candidate with the most intense appeal to a narrow, activated base rather than the broadest appeal across the district. So the premise is worth examining rather than taking for granted.

The more durable answer is in the method itself. The Act's scoring method is built to reward broad acceptability, not intensity from a narrow coalition, and its automatic runoff requires the winner to be preferred by a majority of the two finalists. That is the design objective: a winner has to earn support across the full electorate, not simply prevail with a plurality while the opposition splits. The filtering that a primary was meant to perform happens in the count instead — and it happens in the election where every voter is present, rather than in a preliminary round where only a fraction are.

---

## What Full-Field Elections Cover — and What They Don't
...
- Hub exclusions enforced: "abolish/eliminate/end primaries" barred throughout (affirmative full-field standard plus two prohibitions used instead); no comparatives except to the status quo (no top-two, jungle primary, RCV, or open/closed-primary reforms named as rivals); facts-on-the-ground (Sonnet's contested historical "democratic corrective" narrative dropped; structural turnout/decided-in-primary effect stated, primaries-cause-extremism causal claim not asserted; fringe-candidate answer held to design objective, not outcome prediction)
- Sore-loser handled per author decision (option 1, light touch): practical effect stated in Scope, effect only, no statute numbers, case names, or preemption doctrine — first voter-facing home for the sore-loser practical consequence
- Ballot endorsement detail ("up to three party endorsements") verified against legislative text Section 203(a) before inclusion
...
> 📥 [Download this document](https://github.com/albertintech/apai/blob/main/docs/congress/cmf/cema/full-field-elections.md) (opens on GitHub -- click the ⬇ download button)
