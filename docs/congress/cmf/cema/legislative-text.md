...
- **Section 404(f)(3) updated:** Replaced 402(a) schedule reference with First CEMA Election
- **Section 406 deleted:** Removed transition protection for incumbents (marked Reserved)
- **Section 408(b) updated:** Replaced "Transition Cycle 1" with "First CEMA Election"
...
- **Section 606(e) updated:** Replaced "Transition Cycle 1" effective date with "First CEMA Election"
- **Section 607(c) updated:** Removed Section 605 from Senate non-applicability list
- **Section 610(b) updated:** Removed Section 605 from implementation timeline; updated Section 606 reference to First CEMA Election; subsection heading updated from "Conditional Implementation Dates" to "First CEMA Election"
...
- **New Section 301 (House Expansion Schedule):** Initial expansion to 510 seats at First CEMA Election, followed by biennial +35 seat increases until cube root compliance (~14 years)
- **New definitions added to Title VIII:** "First CEMA Election" (Titles I-IV trigger) and "Second CEMA Election" (Title V trigger) replace phase-based temporal definitions
- **Tiered effective date structure:**
  - Titles VI, VII, VIII: Immediate upon enactment
  - Titles I, II, III, IV: First CEMA Election (second general election after enactment, 18-month minimum floor)
  - Title V (FCAO): Second CEMA Election with 18/12 month validation/administration deadlines
- **New Title V Section 505:** FCAO effective date and implementation timeline with explicit First CEMA Election exemption
- **Replacement Finding #14:** Updated ratios and timeline language; removed inaccurate phase references and seat counts
- **Section 302 updated:** Infrastructure preparation timeline aligned with First CEMA Election trigger
- **Section 303 updated:** MRA increase timing aligned with First CEMA Election
- **Title IV Section 402 updated:** Transition Cycle definitions reference First CEMA Election
...
> 📥 [Download this document](https://github.com/albertintech/apai/blob/main/docs/congress/cmf/cema/legislative-text.md) (opens on GitHub -- click the ⬇ download button)
