...
**Title V -- Compensation, Transition, and Implementation.** Provides immediate capacity improvements upon enactment: phased salary increases over five years (House to $250,000, Senate to $300,000), enhanced pension accrual (2.5% vs. 1.7%), and professional development funding (5% of base salary). Also establishes public campaign matching funds (6:1 for contributions under $200 in multi-member districts), streamlined Senate appointment authority, and $500 million in initial federal grants to states for implementation support. Members may voluntarily forgo the salary increase above the pre-enactment rate through an annual, irrevocable compensation hold (Section 502(e)), providing a clean opt-out for members who support the Act's structural reforms but face constituency pressure on pay increases. These provisions serve dual purposes: political viability (immediate benefits aligning incumbent incentives with reform) and governance improvement (enhanced legislative capacity independent of electoral changes).

**Title VI -- Enforcement and Reporting.** Grants expanded enforcement authority to the Federal Election Commission and Department of Justice for Act compliance. Establishes coordination requirements between the FEC and ESO. Includes supermajority protection against compensation rollbacks (three-fifths vote required to reduce Title V benefits), severability protection ensuring compensation mechanisms survive if reform titles are invalidated, and anti-retaliation provisions.
...
**Tier 1 -- Immediate upon enactment.** Titles V, VI, and VII take effect, delivering compensation improvements, enforcement authority, and administrative framework. The ESO begins establishment. Members who vote for the Act see benefits during the same Congress.
...
- Presidential scope narrowing: narrowed "federal election systems" to "congressional election systems" in opening paragraph; narrowed "all federal elections" to "all congressional elections" in Title IV summary and Tier 2 implementation description; narrowed "federal offices" to "congressional offices" in UGES description; "federal elections" retained in constitutional analysis context (Elections Clause discussion) where it describes constitutional authority rather than CEMA scope
- FCAO references removed: Title V (FCAO) extracted from CEMA into planned standalone statute under the CMF; removed Title V summary paragraph; removed "candidate transparency" from reform component list; removed FCAO from Title VII (now Title VI) coordination requirements and Constitutional Foundation; removed Tier 3 from Implementation Architecture; removed Second CEMA Election from illustrative timeline and General Provisions temporal terms
- Title/section renumbering: Title V (FCAO) removed; Title VI (Compensation) → Title V; Title VII (Enforcement) → Title VI; Title VIII (General Provisions) → Title VII; Tier 1 Title list updated (V, VI, VII)
- Illustrative timeline updated: enactment baseline corrected from 2026 to 2029; First CEMA Election updated from November 2028 to November 2032; cube root compliance updated from ~2040 to ~2046; Second CEMA Election removed
...
- Section 502(e) Voluntary Compensation Hold: inserted single-sentence description into Title V summary paragraph
...
- Revised Title III summary: added redistricting reference to algorithmic methods in Title IV
- Revised Title IV summary: replaced five-cycle multi-member district transition with single implementation at First CEMA Election for all qualifying states; added small state application (one-Representative states at-large, two-Representative states in algorithmically drawn SMDs); added algorithmic districting paragraph covering ESO-certified algorithm, shortest splitline default, deterministic magnitude preference ordering, and VRA minimum boundary adjustment; expanded ESO paragraph to include districting responsibilities, Tier 1 algorithmic neutrality principle, Tier 2 magnitude range, Tier 3 districting parameters, and Section 410 independence protections
- Revised Title VI summary: removed "transition protections allowing incumbents to remain in single-member districts during the multi-member phase-in" (Section 605 deleted in Rev 5.1)
- Revised Title VIII summary: removed "Full Implementation" from temporal terms list (deleted in Rev 5.1); added algorithmically neutral districting terminology and district magnitude to definitions reference
- Revised Implementation Architecture, Tier 2: replaced "Multi-member districts begin phasing in at 25% of seats" with "Multi-member districts take effect for all qualifying states"; added "Algorithmically neutral districting becomes operational"
- Revised Implementation Architecture, Ongoing: removed five-transition-cycle reference; added redistricting trigger language
- Revised illustrative timeline: updated First CEMA Election description from "initial multi-member districts" to "multi-member districts for all qualifying states"
- Revised Constitutional Foundation: added algorithmic districting authority under Elections Clause
...
> 📥 [Download this document](https://github.com/albertintech/apai/blob/main/docs/congress/cmf/cema/overview.md) (opens on GitHub -- click the ⬇ download button)
